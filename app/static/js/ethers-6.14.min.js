/*!
 * ethers v6.14.0 — vendored from https://unpkg.com/ethers@6.14.0/dist/ethers.umd.min.js
 * (UMD build; full MIT license header is embedded in the minified bundle below).
 * Downloaded at apply time (PR-B WU4, design id 52 D1). Re-fetch with:
 *   curl -LsSf https://unpkg.com/ethers@6.14.0/dist/ethers.umd.min.js -o app/static/js/ethers-6.14.min.js
 * The browser signs EIP-712 TransferWithAuthorization envelopes via
 * `ethers.BrowserProvider.getSigner().signTypedData(...)` — see payment.js.
 */
